...
\item $EV_n$ als Abkürzung für $\left({[n]\choose 2} \times [n]\right) \backslash \mathop{\dot{\bigcup}}\limits_{\left\{v_1, v_2\right\} \in {[n]\choose 2}} \left(\left\{v_1, v_2\right\}, v_1\right) \mathbin{\dot{\cup}} \left(\left\{v_1, v_2\right\}, v_2\right)$
