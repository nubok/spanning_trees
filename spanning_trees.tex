...
\item $0$ für $P^{K_n, spt, symm, r_{\left(v, w\right)}+r_{\left(w, v\right)}}$ (vgl.  Korollar \ref{kor:linearisiert_C_symm_vereinfacht}), $P^{K_n, spt, symm, xy}$ (vgl. Korollar \ref{kor:loesung_transponiert_nsymmxy}) und $P^{K_n, spt, asymm, 4}$ (vgl. Lemma \ref{le:linearisiert_asymm4_vereinfacht})
\end{itemize}
