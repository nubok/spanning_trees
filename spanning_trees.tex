...
\item $\binom{S}{n}$ als die Menge aller n-elementigen Teilmengen von S
...
\item $EV_n$ als Abkürzung für $\left(\binom{[n]}{2} \times [n]\right) \backslash \mathop{\dot{\bigcup}}\limits_{\left\{v_1, v_2\right\} \in \binom{[n]}{2}} \left(\left\{v_1, v_2\right\}, v_1\right) \mathbin{\dot{\cup}} \left(\left\{v_1, v_2\right\}, v_2\right)$
...
\item $E \left(S\right) := \binom{S}{2} \cap E$ und $A\left(S\right) := S^{\underline{2}} \cap A$
...
\begin{Def}
Sei $V$ (Knotenmenge -- "`vertices"') endlich und nichtleer und sei $E \subseteq \binom{V}{2}$ (Kantenmenge -- "`edges"'). Dann bezeichnen wir $\left(V, E\right)$ als \emph{Graph}.
...
\begin{BspDef}
Sei $n \geq 1$. Dann definieren wir $K_n := \left(\left[n\right], \binom{\left[n\right]}{2}\right)$ als den \emph{vollständigen Graphen} auf der Knotenmenge $\left[n\right]$.
...
\begin{Def}
Sei $G=(V, E)$ ein Graph und $V' \subseteq E$ und $E' \subseteq \binom{V'}{2} \cap E$. Dann heißt $\left(V', E'\right)$ ein \emph{Untergraph} oder \emph{Subgraph} von $G$.
\end{Def}

\begin{Def}
Seien $G_1=(V_1, E_1)$ und $G_2=(V_2, E_2)$ Graphen. Wir nennen $G_1$ und $G_2$ \emph{isomorph}, wenn es eine bijektive Abbildung $\Psi : V_1 \rightarrow V_2$ gibt, so dass für alle $\left\{v, v'\right\} \in \binom{V_1}{2}$ gilt: $\left\{\Psi\left(v\right), \Psi\left(v'\right)\right\} \in E_2 \Leftrightarrow \left\{v, v'\right\} \in E_1$ .
\end{Def}
...
\item $G$ ist maximal kreisfrei (d. h. kreisfrei und für alle $e\in \binom{V}{2} \backslash E$ gilt: $(V, E \mathbin{\dot{\cup}} \left\{e\right\})$ enthält einen Kreis)
...
\begin{displaymath}
\delta_E \left(\mathcal{P}\right) := \left\{ \left\{v_1, v_2\right\}: v_1 \in P_1, v_2 \in P_2, \left\{P_1, P_2\right\} \in \binom{\mathcal{P}}{2} \right\} \cap E.
\end{displaymath}
...
\left\{v_1, v_2\right\} \in E}} x_{\left\{v_1, v_2\right\}} + \sum_{\left\{v_1, v_2\right\} \in {\binom{\left[n\right] \backslash S}{2}} \cap E} x_{\left\{v_1, v_2\right\}}\right) \\
...
(Cayley-Formel)
\begin{displaymath}
\left|\left\{T \subseteq \binom{\left[n\right]}{2}: T\textnormal{ aufspannender Baum in }K_n\right\}\right| = n^{n-2}.
\end{displaymath}
\end{Sa}
...
2 x_{\left\{v_1, v_2\right\}} + \sum_{u \in \left[n\right] \backslash \left\{v_1, v_2\right\}} y_{\left\{v_1, v_2\right\}, u} & \substack{= \\ \leq \\ \geq} & 2 \ \forall \left\{v_1, v_2\right\} \in {\left[n\right] \choose 2} \label{eq:simpl_sum2} \\
...
\allowdisplaybreaks
\begin{align*}
& \sum_{\left\{v_1, v_2\right\} \in {S \choose 2}} \sum_{u \in \left[n\right] \backslash \left\{v_1, v_2\right\}} y_{\left\{v_1, v_2\right\}, u} \\
= & \frac{1}{\left|S\right|}
\sum_{\left\{v_1, v_2, v_3\right\} \in {S \choose 3}}
\left(
\sum_{u \in \left[n\right] \backslash \left\{v_1, v_2\right\}} y_{\left\{v_1, v_2\right\}, u}
+ \sum_{u \in \left[n\right] \backslash \left\{v_1, v_3\right\}} y_{\left\{v_1, v_3\right\}, u}
+ \sum_{u \in \left[n\right] \backslash \left\{v_2, v_3\right\}} y_{\left\{v_2, v_3\right\}, u}
\right)
\\
& + \frac{2}{\left|S\right|} \left(
\sum_{\left\{v_1, v_2\right\} \in {S \choose 2}} \sum_{u \in S \backslash \left\{v_1, v_2\right\}} y_{\left\{v_1, v_2\right\}, u}
+ 
\sum_{\left\{v_1, v_2\right\} \in {S \choose 2}} \sum_{u \in \left[n\right] \backslash S} y_{\left\{v_1, v_2\right\}, u}
\right) \\
= & \frac{1}{\left|S\right|}
\sum_{\left\{v_1, v_2, v_3\right\} \in {S \choose 3}}
\left(
\sum_{u \in \left[n\right] \backslash \left\{v_1, v_2, v_3\right\}} \left(
y_{\left\{v_1, v_2\right\}, u}
+ y_{\left\{v_1, v_3\right\}, u}
+ y_{\left\{v_2, v_3\right\}, u}
\right)
\right. \\
& \left.
+ 2 \left(y_{\left\{v_1, v_2\right\}, v_3} + y_{\left\{v_1, v_3\right\}, v_2} + y_{\left\{v_2, v_3\right\}, v_1}\right)
\right)
\\
& + \frac{2}{\left|S\right|} \left(
\sum_{\left\{v_1, v_2\right\} \in {S \choose 2}} \sum_{u \in S \backslash \left\{v_1, v_2\right\}} y_{\left\{v_1, v_2\right\}, u}
...
& + \frac{2}{\left|S\right|}
\sum_{\left\{v_1, v_2\right\} \in {S \choose 2}} \sum_{u \in \left[n\right] \backslash S} y_{\left\{v_1, v_2\right\}, u} \\
\stackrel{y \geq 0}{\geq} & \frac{1}{\left|S\right|}
\sum_{\left\{v_1, v_2, v_3\right\} \in {S \choose 3}}
\left(
\sum_{u \in \left[n\right] \backslash \left\{v_1, v_2, v_3\right\}} \left(
y_{\left\{v_1, v_2\right\}, u}
...
x_{\left\{v_1, v_2\right\}} & \geq & 0 \ \forall \left\{v_1, v_2\right\}\in {\left[n-1\right] \choose 2}\textnormal{, falls $P^{K_n, for}$} \nonumber \\
...
& & \left. + \sum_{v_2 \in \left[\max S - 1\right] \backslash \left\{v_1\right\}} z_{\left(v_1, v_2\right), \max S}\right) \\
